...
public class CisIfLogSO extends BaseSearchVO<CisIfLogSO> {
	...
	private String sysReqStartDtmStart;  /* 요청시작일시 조회조건 시작일 */
	private String sysReqStartDtmEnd;    /* 요청시작일시 조회조건 종료일 */
}
