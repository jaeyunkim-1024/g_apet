...
<div class="layers" id="mpTermsLayers" style="display:none;">
	<c:forEach items="${termsList }" var="term" varStatus="stat">
	<!-- 이용 약관 -->
	<article class="popLayer a popWoozooTerm" id="mpTermsContentPop_bc${stat.index }">
		${term.content }
	</article>
	</c:forEach>
</div>
...
<script type="text/javascript">
	...
	function closeSktmpPop(){
		ui.confirm('멤버십 등록을 취소할까요?',{ // 컨펌 창 옵션들
			ycb:function(){
				resetCardPop();
				closeLayer('popSktmp');
			},
	...
	var popServiceList2 = function(index){
		ui.popLayer.open('mpTermsContentPop_bc'+index);
	}
</script>