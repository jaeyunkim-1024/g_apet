...
<%	
	...
	String orderNo 			   = request.getParameter("orderNo").replaceAll(xssCheckStr,"");  				   // 주문번호
	String cancelPaymentAmount = request.getParameter("cancelPaymentAmount_mile").replaceAll(xssCheckStr,""); // 마일리지 취소할 주문서의 원 금액
	String outStr = "";
	...
	try{
		...
		//e.printStackTrace();
		System.out.println("Exception when payco_mileage_cancel");
	}
%>