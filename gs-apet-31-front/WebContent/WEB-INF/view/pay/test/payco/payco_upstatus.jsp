...
<%
	...
	String sellerOrderProductReferenceKey = (String)request.getParameter("sellerOrderProductReferenceKey").replaceAll(xssCheckStr,"");	//외부가맹점에서 관리하는 주문상품키
	String orderProductStatus 			  = (String)request.getParameter("orderProductStatus").replaceAll(xssCheckStr,"");				//변경할 주문상태
	String returnStr = "";
	...
	try{
		...
		//e.printStackTrace();
		System.out.println("Exception when payco_updataus");
	...
	try{
		...
		// 보안성 진단. 오류메시지를 통한 정보노출
		//e.printStackTrace();
		System.out.println("Exception when payco_updataus printwriter");
	}
