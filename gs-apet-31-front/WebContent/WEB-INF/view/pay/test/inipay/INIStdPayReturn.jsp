...
<% 
	...
	try{
		...
		while(elems.hasMoreElements())
		{
			...
			paramMap.put(temp, request.getParameter(temp).replaceAll(xssCheckStr,""));
		}
		
		out.println("paramMap : "+ paramMap.toString());
...
// 					out.println("<td class='td02'><p>" +resultMap.get("applPrice")+"원</p></td></tr>");
		...
		out.println("INIStdPayReturn fail!");
	}
%>
