<%--	
 - Class Name	: /common/exception/error404.jsp
			...
			<div class="inr">
				...
				<div class="contents error-wrap-area" id="contents">
					...
					<div class="error-area">
						<div class="error">
							<p class="txt"><spring:message code='front.web.view.common.msg.error.404'/></p>
							<p class="txt-s">
								<spring:message code='front.web.view.common.msg.error.404.notice'/>
							</p>
							<div class="btnSet">
