<%--	
 - Class Name	: /common/exception/error.jsp
			...
			<div class="inr">
				...
				<div class="contents error-wrap-area" id="contents">
					...
					<div class="error-area">
						<div class="error">
							<p class="txt"><spring:message code='front.web.view.common.msg.error.500'/></p>
							<p class="txt-s">
								<spring:message code='front.web.view.common.msg.error.500.notice'/>
							</p>
							<div class="btnSet">
