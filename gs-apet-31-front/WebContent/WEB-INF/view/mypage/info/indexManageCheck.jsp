	...
	<tiles:putAttribute name="script.inline">
		...
		<script type="text/javascript">
			...
			function checkMemberPassword(){
				...
				var options = {
					url : "<spring:url value='/mypage/info/checkMemberPassword' />",
					data : {
						pswd : pswd_enc,
					},
					done : function(data){
...
<!-- 			<div class="inr"> -->
<!-- 				<div class="hdt"> -->
<%-- 					<button class="back" id="goBackBtn" type="button" onclick="goBack();" data-content="" data-url="${empty returnUrl ? '/mypage/indexMyPage' : returnUrl }">뒤로가기</button> --%>
<!-- 				</div> -->
...
<!-- 		</div> -->
		...
		<main class="container page login srch" id="container">
			...
			<div style="display:none;">
				...
				<form action="${redirectUrl}" method="POST" id="checkForm">
					...
					<div class="fake-pop">
						...
						<div class="pbt mt30">
							<div class="btnSet" id="confirmBtn">
								<a href="javascript:;" class="btn lg a gray" data-url="/mypage/info/checkMemberPassword" data-content="${session.mbrNo}" disabled>확인</a>
							</div>
						</div>
					</div>
				</div>
