...
<tiles:insertDefinition name="common">
			...
			function getSortGoodsList(order){
				...
				var options = {
					...
					, data : {
						...
						,dispCornNo : $("#dispCornNo_stock").val()
						,dispClsfCornNo : $("#dispClsfCornNo_stock").val()
						,dispType : $("#dispCornType_stock").val()
						,page : page
						,rows : rows
						,order: order
					}
	...
	<!-- 할인상품 -->
	<input type="hidden" id="dispCornType_stock" value="${frontConstants.GOODS_AMT_TP_50}"/>
	<input type="hidden" id="dispCornNo_stock" value="${so.dispCornNo}"/>
	<input type="hidden" id="dispClsfCornNo_stock" value="${so.dispClsfCornNo}"/>
	<main class="container lnb page shop hm discn" id="container">
		<div class="pageHeadPc lnb">
			<div class="inr">
				<div class="hdt">
					<h3 class="tit">폭풍 할인상품</h3>
				</div>
			</div>
		</div>
		<div class="inr">
