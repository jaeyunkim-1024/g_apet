...
<tiles:insertDefinition name="common">
			...
			function getSortGoodsList(order){
				...
				var options = {
					...
					, data : {
						...
						,dispCornNo : $("#dispCornNo_md").val()
						,dispClsfCornNo : $("#dispClsfCornNo_md").val()
						,dispType : $("#dispCornType_md").val()
						,page : page
						,rows : rows
						,order: order
					}
	...
	<input type="hidden" id="dispCornType_md" value="${frontConstants.GOODS_MAIN_DISP_TYPE_MD}"/>
	<input type="hidden" id="dispCornNo_md" value="${so.dispCornNo}"/>
	<input type="hidden" id="dispClsfCornNo_md" value="${so.dispClsfCornNo}"/>
		<main class="container lnb page shop hm mdpic" id="container">
			<div class="pageHeadPc lnb">
				<div class="inr">
					<div class="hdt">
						<h3 class="tit">MD추천 상품</h3>
					</div>
				</div>
			</div>
			<div class="inr">
				...
				<div class="contents" id="contents">
					<section class="sect ct mdpic">
						<div class="uioptsorts mdpic">
							<div class="dx lt"></div>
							<div class="dx rt">
								<nav class="uisort">
