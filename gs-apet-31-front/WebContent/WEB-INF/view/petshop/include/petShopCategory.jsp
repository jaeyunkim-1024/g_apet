...
<c:if test="${not empty totalCornerList[0].recommendGoodsList}">
<section class="sect ct recmd">
	<div class="hdts">
		<a class="hdt" href="javascript:void(0);"><span class="tit">추천상품</span> </a>
	</div>
	<div class="ct_recmd_sld"><!-- ui.disp.sld.recmd.using(); -->
		<div class="sld-nav">
		...
		<div class="swiper-container slide">
			<ul class="swiper-wrapper list">
				<c:forEach var="goods" items="${totalCornerList[0].recommendGoodsList }"  varStatus="status" >
				<li class="swiper-slide">
					<div class="gdset recmd">
	...
	<div class="sticky_filter">
		<div class="inr">
			<div class="uioptsorts cates">
				<div class="dx lt">
					<div class="tot"><spring:message code='front.web.view.common.total.title'/><em class="n">${goodsCount}</em><spring:message code='front.web.view.common.total.goods.count.title' /></div>
				</div>
				<div class="dx rt">
					<nav class="filter">
					...
					<nav class="uisort only_down">
						...
						<div class="list">
							<ul class="menu">
								<li class="${so.order == 'SALE' ? 'active' : '' }"id="order_SALE"><button type="button" class="bt" value="SALE"><spring:message code='front.web.view.common.menu.sort.orderSale.button.title'/></button></li>
								<li class="${so.order == 'SCORE' ? 'active' : '' }"id="order_SCORE"><button type="button" class="bt" value="SCORE"><spring:message code='front.web.view.common.menu.sort.orderScore.button.title'/></button></li>
								<li class="${so.order == 'DATE' ? 'active' : '' }" id="order_DATE"><button type="button" class="bt" value="DATE"><spring:message code='front.web.view.common.menu.sort.orderDate.button.title'/></button></li>
								<li class="${so.order == 'LOW' ? 'active' : '' }"id="order_LOW"><button type="button" class="bt" value="LOW"><spring:message code='front.web.view.common.menu.sort.orderLow.button.title'/></button></li>
								<li class="${so.order == 'HIGH' ? 'active' : '' }"id="order_HIGH"><button type="button" class="bt" value="HIGH"><spring:message code='front.web.view.common.menu.sort.orderHigh.button.title'/></button></li>
							</ul>
						</div>
					</nav>
				</div>
