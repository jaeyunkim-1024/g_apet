...
* - 파일명		: ViewMyPageArgumentResolver.java
* - 작성일		: 2016. 3. 2.
* - 작성자		: snw
* - 설명			:
* </pre>
...
@Slf4j
@Deprecated
public class ViewMyPageArgumentResolver implements HandlerMethodArgumentResolver {
	...
	public Object resolveArgument(MethodParameter methodParameter,
		...
		ViewMyPage view = new ViewMyPage();
	    ...
	    if(session.getMbrNo() != null){
			...
			view.setBlcRmnAmt(member.getBlcRmnAmt());
			...
			Long refundSchdAmt= this.memberService.getMemberRefundSchdAmt(so);
			view.setRefundSchdAmt(refundSchdAmt);
	    }
	...
	public boolean supportsParameter(MethodParameter methodParameter) {
		return methodParameter.getParameterType().equals(ViewMyPage.class);
	}
