...
import front.web.config.view.ViewMain;
...
* - 파일명		: ViewMainArgumentResolver.java
* - 작성일		: 2016. 3. 2.
* - 작성자		: snw
* - 설명			:
* </pre>
...
@Slf4j
@Deprecated
public class ViewMainArgumentResolver implements HandlerMethodArgumentResolver {
	...
	public Object resolveArgument(MethodParameter methodParameter, 
		...
		log.debug("!!!!!!!!!!!!!!!!!!!!!!!!!!!! ViewMain Argument Resolver !!!!!!!!!!!!!!!!!!!!!!!!!!!");
	...
	public boolean supportsParameter(MethodParameter methodParameter) {
		return methodParameter.getParameterType().equals(ViewMain.class);
	}
