<%@ page pageEncoding="UTF-8" contentType="text/html; charset=utf-8" %>
	<div class="mTitle mt30">
		...
		<div class="buttonArea">
			<button type="button" onclick="displayCornerBnrAddPop();" class="btn btn-add">추가</button>
			<button type="button" onclick="displayCornerItemBnrDelete();" class="btn btn-add">삭제</button>
		</div>
	</div>

	<form name="displayCornerItemBannerForm" id="displayCornerItemBannerForm">
		...
		<div class="mModule no_m">
			<table id="displayCornerItemBannerList"></table>
		</div>
	</form>