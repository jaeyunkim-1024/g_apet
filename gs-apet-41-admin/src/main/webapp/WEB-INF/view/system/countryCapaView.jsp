		...
		<table class="table_type1">
			...
			<tbody>
				<tr>
					...
					<th scope="row"><spring:message code="column.area_cd" /></th>
					<td>
						<select name="areaCd" id="areaCd" title="<spring:message code="column.area_cd" />">
							<frame:select grpCd="${adminConstants.AREA}" usrDfn1Val="20"/>
						</select>
					</td>
				</tr>
			</tbody>
