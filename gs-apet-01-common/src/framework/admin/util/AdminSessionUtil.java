...
public class AdminSessionUtil {
	...
	public static Session getSession() {
		return (Session) SessionUtil.getAttribute(AdminConstants.HTTP_SESSION);
	}
	...
	public static void setSession(Session session) {
		SessionUtil.setAttribute(AdminConstants.HTTP_SESSION, session);
	}
	...
	public static void removeSession() {
		SessionUtil.removeAttribute(AdminConstants.HTTP_SESSION);
	}
