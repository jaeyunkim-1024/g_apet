 ...
 * @since 2018. 05. 17.
 */
public class BirthDayMaskFormatSupport extends BodyTagSupport {

	private static final long serialVersionUID = 8980936695744525096L;
	...
	public static void format(PageContext pageContext, String data) throws IOException {
		...
		if (data != null && !"".equals(data)) {
			...
			Matcher matcher = Pattern.compile("^(.*)(\\d{2})([일]*)$").matcher(data);
