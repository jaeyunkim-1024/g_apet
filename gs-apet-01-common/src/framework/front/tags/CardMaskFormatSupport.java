 ...
 * @since 2018. 05. 17.
 */
public class CardMaskFormatSupport extends BodyTagSupport {

	private static final long serialVersionUID = -5438777469536520618L;
	...
	public static void format(PageContext pageContext, String data) throws IOException {
		...
		if (data != null && !"".equals(data)) {
			...
			Matcher matcher = Pattern.compile("^([0-9]{1,4})\\-?([0-9]{1,4})\\-?([0-9]{1,4})\\-?([0-9]{1,4})$").matcher(data);
