...
public class SlaveAbstractDao {
	...
	public <E> List<E> selectListPage(String statement, BaseSearchVO<?> vo) {
		...
		return slaveSqlSessionTemplate.selectList(statement, vo);
	}
	...
	private int countByParam(String statement, BaseSearchVO<?> baseSearchVO) {
		Object resultObj = slaveSqlSessionTemplate.selectOne(statement, baseSearchVO);
	...
	public <T> T selectOne(String statement) {
		log.info("##### {}", statement);
		return slaveSqlSessionTemplate.selectOne(statement);
	}

	public <T> T selectOne(String statement, Object parameter) {
		log.info("##### {}", statement);
		return slaveSqlSessionTemplate.selectOne(statement, parameter);
	}

	public <K, V> Map<K, V> selectMap(String statement, String mapKey) {
		log.info("##### {}", statement);
		return slaveSqlSessionTemplate.selectMap(statement, mapKey);
	}

	public <K, V> Map<K, V> selectMap(String statement, Object parameter, String mapKey) {
		log.info("##### {}", statement);
		return slaveSqlSessionTemplate.selectMap(statement, parameter, mapKey);
	}

	public <K, V> Map<K, V> selectMap(String statement, Object parameter, String mapKey, RowBounds rowBounds) {
		log.info("##### {}", statement);
		return slaveSqlSessionTemplate.selectMap(statement, parameter, mapKey, rowBounds);
	}

	public <E> List<E> selectList(String statement) {
		log.info("##### {}", statement);
		return slaveSqlSessionTemplate.selectList(statement);
	}

	public <E> List<E> selectList(String statement, Object parameter) {
		log.info("##### {}", statement);
		return slaveSqlSessionTemplate.selectList(statement, parameter);
	}
	...
	public <E> List<E> selectList(String statement, Object parameter, RowBounds rowBounds) {
		log.info("##### {}", statement);
		return slaveSqlSessionTemplate.selectList(statement, parameter, rowBounds);
	}

	public void select(String statement, ResultHandler handler) {
		log.info("##### {}", statement);
		slaveSqlSessionTemplate.select(statement, handler);
	}

	public void select(String statement, Object parameter, ResultHandler handler) {
		log.info("##### {}", statement);
		slaveSqlSessionTemplate.select(statement, parameter, handler);
	}

	public void select(String statement, Object parameter, RowBounds rowBounds, ResultHandler handler) {
		log.info("##### {}", statement);
		slaveSqlSessionTemplate.select(statement, parameter, rowBounds, handler);
	}

	public void cacheClear() {
		Configuration configuration = slaveSqlSessionTemplate.getConfiguration();
